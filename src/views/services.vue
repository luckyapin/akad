      ...
      <div class="advantages wow animate__fadeInUpSmall">
        <ul>
          <li>
            ...
            <div class="title">KEEP PULSE GOING</div>
            <div class="subtitle">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
          ...
          <li>
            <div class="icon"><ion-icon name="flash-outline"></ion-icon></div>
            <div class="title">GREAT IDEAS</div>
            <div class="subtitle">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
              eiusmod tempor incididunt.
            </div>
          ...
          <li>
            <div class="icon"><ion-icon name="options-outline"></ion-icon></div>
